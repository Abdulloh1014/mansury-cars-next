	...
	const data: any = {
		car: [
			...
			},
			{
				...
				content: 'Simply use our search bar to enter location, price range, bedrooms/bathrooms, and car type.',
			},
			{
			...
			},
			{
				...
				subject: 'Do you offer cars in specific neighborhoods?',
			...
			},
			{
				...
				content: 'Absolutely, we provide services for selling cars as well.',
			},
			{
		...
		payment: [
			...
			},
			{
				...
				content: 'Yes, we offer installment payment plans for certain cars. Please inquire for more details.',
			},
			{
		...
		buyers: [
			{
				...
				content: 'Buyers should check and decide whether the car they want to buy or rent is actually suitable!',
			},
			{
